...
export default function MyProfile() {
  ...
  const stats = {
    projectsCount: user?.projects?.length || 14,
    reviews: 48,
    likes: 342,
    views: '2.8k'
  };
      ...
      <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-3xl p-6 md:p-8 shadow-sm relative overflow-hidden z-10">
        ...
        <AnimatePresence mode="wait">
          {!isEditing ? (
              ...
              <div className="lg:col-span-2 flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <p className="text-sm text-[#6B7280] font-normal leading-relaxed max-w-xl">
                    {user.bio || "No bio added yet. Click Edit Profile to add custom details about your work experience."}
                  </p>
              ...
              <div className="flex flex-col gap-4 h-full justify-between lg:border-l lg:border-[#E5E7EB] lg:pl-8">
                ...
                <div className="w-full pt-2">
                  <motion.button 
                    ...
                    className="w-full border border-[#E5E7EB] text-[#111827] bg-[#FFFFFF] py-2.5 rounded-xl font-semibold flex items-center justify-center space-x-2 shadow-2xs text-xs tracking-wide transition-all"
                  >
            ...
            /* ================= REDESIGNED PREMIUM EDIT MODE FORM ================= */
            <motion.form 
              key="edit-mode"
              initial={{ opacity: 0, y: 5 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex flex-col items-center space-y-4 shrink-0 bg-[#F8FAFC] border border-[#E5E7EB] p-5 rounded-2xl">
                  <div className="relative group">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#2563EB] to-[#3B82F6] rounded-full blur opacity-30"></div>
                    <img 
                      src={formData.profileImage || '/default-avatar.png'} 
                      alt="Preview avatar" 
                      className="w-24 h-24 md:w-28 md:h-28 rounded-full object-cover border-4 border-[#FFFFFF] shadow-md relative z-10"
                      onError={(e) => {
                  ...
                  <div className="w-full max-w-xs space-y-1">
                    <label className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Profile Image URL</label>
                    <input 
                      type="text" 
                      name="profileImage"
                      value={formData.profileImage}
                      onChange={handleInputChange}
                      className="w-full text-xs px-3 py-2 border border-[#E5E7EB] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB]/10 focus:border-[#2563EB] bg-[#FFFFFF] transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 flex-1">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full text-sm px-3 py-2.5 border border-[#E5E7EB] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB]/10 focus:border-[#2563EB] bg-[#FFFFFF] transition-all"
                    />
                  </div>

                  <div className="space-y-1">
                    <label className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Username</label>
                    <div className="relative">
                      <span className="absolute left-3 top-2.5 text-sm text-[#6B7280] font-mono">@</span>
                      <input 
                        type="text" 
                        name="username"
                        ...
                        onChange={handleInputChange}
                        required
                        className="w-full text-sm pl-7 pr-3 py-2.5 border border-[#E5E7EB] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB]/10 focus:border-[#2563EB] bg-[#FFFFFF] transition-all"
                      />
                    </div>
                  </div>

                  <div className="md:col-span-2 space-y-1">
                    <label className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Bio</label>
                    <textarea 
                      name="bio"
                      value={formData.bio}
                      onChange={handleInputChange}
                      rows={3}
                      className="w-full text-sm px-3 py-2.5 border border-[#E5E7EB] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB]/10 focus:border-[#2563EB] bg-[#FFFFFF] resize-y transition-all"
                    />
                  </div>

                  <div className="md:col-span-2 space-y-1">
                    <label className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Skills (comma separated)</label>
                    <input 
                      type="text" 
                      name="skillsString"
                  ...
                  <div className="space-y-1">
                    <label className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">GitHub URL</label>
                    <input 
                      type="url" 
                      name="githubUrl"
                  ...
                  <div className="space-y-1">
                    <label className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Portfolio URL</label>
                    <input 
                      type="url" 
                      name="portfolioUrl"
              ...
              <div className="flex flex-col sm:flex-row justify-end items-center gap-3 pt-4 border-t border-[#E5E7EB]">
                <button 
                  type="button"
                  onClick={handleCancel}
                  className="w-full sm:w-auto border border-[#E5E7EB] text-[#6B7280] bg-[#FFFFFF] hover:bg-[#F8FAFC] px-4 py-2.5 rounded-xl font-semibold flex items-center justify-center space-x-1.5 text-xs transition-colors"
                >
                ...
                <button 
                  type="submit"
                  className="w-full sm:w-auto bg-[#2563EB] hover:bg-[#1D4ED8] text-white px-5 py-2.5 rounded-xl font-semibold flex items-center justify-center space-x-1.5 text-xs shadow-sm transition-colors"
                >

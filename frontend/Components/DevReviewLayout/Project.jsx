...
export default function SingleProject() {
  ...
  // PREMIUM SKELETON LOADER ENFORCED HERE
  if (!project) {
            ...
            <div className="space-y-2 pt-4 border-t border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`flex items-center justify-center space-x-2 text-xs md:text-sm font-semibold py-2 rounded-xl border transition-all shadow-2xs ${
                    liked 

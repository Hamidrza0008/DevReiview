      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#2563EB] relative items-center justify-center p-12 overflow-hidden border-r border-[#E5E7EB]/10">
        ...
        <div className="relative z-10 max-w-xl w-full text-white space-y-8">
          ...
          <div className="relative bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl flex flex-col items-center justify-center py-14">
            ...
            <p className="text-xs font-mono text-blue-200 tracking-widest uppercase">Cryptographic Key Vault Recovery</p>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <AnimatePresence mode="wait">
            {!isSent ? (
              ...
              >
                <div>
                  <label className="block text-xs font-bold text-[#111827] uppercase tracking-wider mb-2">Account Node Email</label>
                  <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="name@company.com" className="w-full px-4 py-3 bg-[#F8FAFC] border border-[#E5E7EB] rounded-lg text-sm focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/10 transition-shadow duration-150" />
                </div>
              ...
              <motion.div 
                ...
                className="p-5 bg-emerald-50/50 border border-emerald-500/20 rounded-2xl mb-4"
              >
                <div className="flex flex-col items-center text-center space-y-3">
                  <div className="w-10 h-10 bg-emerald-500 rounded-full flex items-center justify-center text-white text-base font-bold shadow-sm">✓</div>
                  <div>
                    <h4 className="text-base font-bold text-emerald-900">Transmission Successful</h4>
          ...
          <div className="mt-6 pt-6 border-t border-[#E5E7EB] text-center">
            <a href="/auth/login" className="inline-flex items-center space-x-2 text-sm font-bold text-[#2563EB] hover:text-[#3B82F6]">

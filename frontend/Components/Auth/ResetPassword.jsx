  ...
  return (
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex text-[#111827] font-sans antialiased relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#2563EB] relative items-center justify-center p-12 overflow-hidden border-r border-[#E5E7EB]/10">
        ...
        <div className="relative z-10 max-w-xl w-full text-white space-y-8">
          ...
          <div className="relative bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl flex flex-col items-center justify-center py-14">
            ...
            <p className="text-xs font-mono text-blue-200 tracking-widest uppercase">Cryptographic Key Override Vault</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative z-10">
        ...
        >
          <h2 className="text-2xl font-bold text-[#111827] mb-1">Override Node Access</h2>
          <p className="text-sm text-[#6B7280] mb-6">Enter transmission OTP and overwrite target parameter keys.</p>
            ...
            {!isSuccess ? (
              ...
              >
                <div className="flex flex-col items-center text-center space-y-3">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-emerald-900">Override Complete</h4>
